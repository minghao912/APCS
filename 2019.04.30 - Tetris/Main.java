...
public class Main {
    ...
    public static void createAndShowGame(Grid gameGrid) {
        ...
        win.setIconImage((new ImageIcon(Main.class.getResource("Files/icon.kylebigdumb"))).getImage());
        ...
        hFrame.setIconImage((new ImageIcon(Main.class.getResource("Files/icon.kylebigdumb"))).getImage());
        ...
        cf.setIconImage((new ImageIcon(Main.class.getResource("Files/icon.kylebigdumb"))).getImage());
